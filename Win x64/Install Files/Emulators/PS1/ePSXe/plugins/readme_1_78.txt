P.E.Op.S./Pete's OpenGL driver for PSX emus 
-------------------------------------------
...
download of the DirectX 6 SDK from the internet was >70 MByte (and I
had a very slow connection to the net). And "NoComp" seemed to be working
on a Direct3D GPU. Well, and Segu wasn't lazy, too...

So I looked at the OpenGL API and it seemed to fit...  and there were no 
"real" OpenGL GPUs for PSEmuPro at this time, all, even the one from Kazz, 
were just partial implementations.

I borrowed an OpenGL book from a friend (hi Gamma!) and got to work.

* Some words about the (most likely) last relase, 10 years later, spring 2009:

I did frequent plugin updates until 2003, then I've found less and less
time (and need) to work on it anymore. Well, I wanted to release the plugin
under the GPL by then, but an unpleasant happening with my other Open Source
plugin (P.E.Op.S. soft gpu) made me reconsider this step. 

Later on I decided to release the sources on the 10th anniversary of the 
first release date, and hey, at least I keep what I promise :)
...
And, of course, you can try my D3D plugins, if your card is having OGL troubles :)
...
To avoid tearing in the display you can activate the "V-Sync" option, be aware that
this can cause small slowdowns (well, not really a issue in the year 2009 anymore).
...
two main filtering modes... the Extended mode is slightly slower, but even
...
After all it was a hell of coding... but it was worth the time and I don't 
regret anything :)
I have done all major tests with BOF III and Spyro and a lot of PSX demo CDs, 
if your favorite game doesn't work... bad luck, sorry.
