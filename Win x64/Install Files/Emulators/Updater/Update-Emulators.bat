...
robocopy "Files\RetroArch_Cores" ..\RetroArch\cores\ /E /XO /MOVE
...
robocopy "Files\PCSX2\pcsx2-%newversion%-windows-x86" ..\PS2\PCSX2\ /E /XO /MOVE
copy /y portable.ini "..\PS2\PCSX2\portable.ini"
..\PS2\PCSX2\4gb_patch.exe ..\PS2\pcsx2\pcsx2.exe
...
robocopy Files\Dolphin-x64 ..\Gamecube\Dolphin\ /E /XO /MOVE
...
robocopy Files\RetroArch ..\RetroArch\ /E /XO /MOVE
