...
::robocopy "..\Win x64" "%userprofile%\Desktop\Downloads\Win x64" /E /Z
ECHO.
ECHO Done
...
7zg a -y "%userprofile%\Desktop\Downloads\Updater_v%updaterv%.7z" "%userprofile%\Desktop\Downloads\Win x64\Install Files\Scripts\Updater"
ECHO.
ECHO Done
PING localhost -n 2 >NUL
...
MOVE /y "%userprofile%\Desktop\Downloads\Updater_v%updaterv%.7z" "C:\ftp_root\steamconsole\Updater_v%updaterv%.7z"
ECHO.
ECHO Done
...
7zg a -y "%userprofile%\Desktop\Downloads\Win x64\SteamConsole.7z" "%userprofile%\Desktop\Downloads\Win x64\Install Files\*.*"
ECHO.
ECHO Done
PING localhost -n 2 >NUL

ECHO Removing Install Files folder to prep for NSIS installer build.
RMDIR /S /Q "%userprofile%\Desktop\Downloads\Win x64\Install Files"
ECHO Done
PING localhost -n 2 >NUL
